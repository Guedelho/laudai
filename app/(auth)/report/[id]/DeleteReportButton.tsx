...
export default function DeleteReportButton({ reportId }: { reportId: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 border border-red-200 text-red-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-50 transition-colors print:hidden"
    >
